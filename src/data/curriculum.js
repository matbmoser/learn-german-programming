    ...
    tables: [
      {
        ...
        head: ["Kasus", "Frage", "Maskulin", "Neutrum", "Feminin", "Plural"],
        rows: [
          ["Nominativ", "Wer oder was?", "der", "das", "die", "die"],
          ["Akkusativ", "Wen oder was?", "den", "das", "die", "die"],
          ["Dativ", "Wem?", "dem", "dem", "der", "den + Nomen-n"],
          ["Genitiv", "Wessen?", "des + Nomen-s", "des + Nomen-s", "der", "der"],
        ],
        hot: [[1, 2]],
        warm: [[2, 5]],
      ...
      },
      {
        ...
        head: ["Kasus", "Frage", "Maskulin", "Neutrum", "Feminin", "Plural (kein-)"],
        rows: [
          ["Nominativ", "Wer oder was?", "ein —", "ein —", "eine", "keine"],
          ["Akkusativ", "Wen oder was?", "einen", "ein —", "eine", "keine"],
          ["Dativ", "Wem?", "einem", "einem", "einer", "keinen"],
          ["Genitiv", "Wessen?", "eines", "eines", "einer", "keiner"],
        ],
        hot: [[0, 2], [0, 3], [1, 3]],
